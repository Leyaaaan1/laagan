...
CREATE TABLE public.rider_locations (
                                        ...
                                        started_ride_id VARCHAR(12) NOT NULL REFERENCES public.started_rides(rides_id) ON DELETE CASCADE,
...
-- RIDE CHECKPOINT ARRIVALS (Track participant progress through checkpoints)
...
CREATE INDEX IF NOT EXISTS idx_checkpoint_started_ride ON public.ride_checkpoint_arrivals(started_ride_id);
CREATE INDEX IF NOT EXISTS idx_checkpoint_rider ON public.ride_checkpoint_arrivals(rider_username);
CREATE INDEX IF NOT EXISTS idx_checkpoint_type ON public.ride_checkpoint_arrivals(checkpoint_type);
CREATE INDEX IF NOT EXISTS idx_finished_ride_generated_id ON public.finished_rides(generated_rides_id);
CREATE INDEX IF NOT EXISTS idx_finished_ride_finisher ON public.finished_rides(finisher_username);
CREATE INDEX IF NOT EXISTS idx_finished_ride_participants_ride ON public.finished_ride_participants(finished_ride_id);
CREATE INDEX IF NOT EXISTS idx_finished_ride_participants_rider ON public.finished_ride_participants(rider_username);